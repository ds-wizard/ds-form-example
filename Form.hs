...
import           FormElement.Rendering
import           FormElement.Identifiers
import           FormElement.Tabs
import           FormContext
        ...
        makePaneJq tab =
          ...
          where
            ...
            makeFormSubPane jq =
              ...
              >>= inside
              >>= foldElements (E.children tab) (makeFormContext tabs) (ElemBehaviour { focusAction = tinkerDiagramForElement, blurAction = tinkerDiagramForElementBlur }) 
              >>= JQ.parent
...
--              >>= JQ.parent
              ...
              where
                ...
                loadDiagram jq1 =
                  setHtml
                    "<object class='svg-help' href='http://caniuse.com/#feat=svg' data='/elixir-questionnaire/static/img/data_process.svg' type='image/svg+xml'><br>"
                    jq1
